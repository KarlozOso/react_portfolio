...
const AboutMe = () => {
  return (
    ...
    <div className="max-w-7xl lg:mt[600px]">
        <div className="relative z-50 pb-8 bg-white sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
            <svg className="relative h-full w-48 text-white transform translate-x-1/2"
